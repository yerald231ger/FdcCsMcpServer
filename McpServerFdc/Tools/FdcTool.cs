...
public class FdcTool
{
    ...
    public async Task<string> GetTankDelivery(FdcService fdcService)
    {
    ...
    public async Task<string> GetTankDelivery(FdcService fdcService, [Description("The tank id, and specified also as device id")]int deviceId)
    {
